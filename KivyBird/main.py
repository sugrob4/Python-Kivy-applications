...
snd_bump = MultiAudio('other_f/bump.wav', 4)
snd_game_over = SoundLoader.load('other_f/game_over.wav')
...
class Pipe(BaseWidget):
    ...
    upper_y = AliasProperty(lambda self: self.height - self.upper_len,
